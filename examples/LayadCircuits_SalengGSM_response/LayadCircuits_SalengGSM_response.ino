...
void loop()
{
  ...
  if(salengGSM.isResponseAvailable())//read 1st 32 chars of anything received from the module except SMS
  {
     salengGSM.readResponse();
     Serial.print("Module Response=");
     Serial.println(salengGSM.gsmRx);  
  }
}